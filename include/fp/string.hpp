...
namespace std {
	...
	template<>
	struct formatter<fp::auto_free<fp::string>, char> : public formatter<fp::string, char> {};
}
#endif
...
inline static fp::auto_free<fp::string> operator ""_fpr(const char* p, size_t size) {
	return fp::string_view{fp_string_view_literal((char*)p, size)}.make_dynamic();
}
#endif