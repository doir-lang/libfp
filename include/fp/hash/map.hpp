...
namespace fp {
	...
	public:
		static void initalize_empty_hash_map(hash_map& map, bool store_hashes = should_store_hashes_while_initializing<pair_type>::value){
		...
		hash_map(bool store_hashes = should_store_hashes_while_initializing<pair_type>::value) {
			initalize_empty_hash_map(*this, store_hashes);
		}
