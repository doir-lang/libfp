...
TEST_SUITE("LibFP::C++") {
...
#endif
		auto fmt2 = fp::raii::string::format("{} {}{}\n", "Hello", "World", '!');
	...
	TEST_CASE("String::Equal_Replace") {
		auto str = fp::raii::string{"ball"}.replicate(5);
		auto replaced = str.replace("ball", "look", 0);
	...
	TEST_CASE("Hash::Dictionary") {
		fp::dictionary<int, fp::string_view> dictionary;
		dictionary[2] = "hello";
		dictionary[6] = "world";
		CHECK(dictionary[2] == "hello");
		CHECK(dictionary[6] == "world");
	}
